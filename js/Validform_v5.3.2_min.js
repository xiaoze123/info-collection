...
(function(d, f, b) {
	...
	function c() {
		...
		j = d('<div id="Validform_msg"><div class="Validform_title"><a class="Validform_close" href="javascript:void(0);"></a></div><div class="Validform_info-box"><img src="img/msg-icon.png"/><div class="Validform_info"></div></div><div class="iframe"><iframe frameborder="0" scrolling="no" height="100%" width="100%"></iframe></div></div>').appendTo("body");
